...
const PostAuctionForm = ({
  ...
  return (
    <div className="fixed h-full top-0 bottom-0 flex flex-col   w-full items-center">
      <div className="bg-black-500  w-full h-full absolute opacity-70 " />

      <form className=" flex my-auto flex-col  relative h-[850px] w-[700px] py-6 z-50 bg-white rounded-2xl border-teal">
        <div className="rounded-lg bg-white absolute z-50 w-full top-0 flex items-center justify-center border-0 border-b-[1px] border-b-[#D8D8D8] h-[98px] p-5 text-textBlack">
